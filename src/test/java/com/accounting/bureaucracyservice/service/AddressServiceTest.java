...
import com.accounting.bureaucracyservice.service.service.impl.AddressServiceImpl;
...
class AddressServiceTest {
    ...
    void getExistingAddress() {
        ...
        Mockito.when(addressRepository.findByRegionAndCityAndStreetAndHouseNumber(any(), any(), any(), any()))
                        .thenReturn(List.of(address));

        addressService.getOrSave(dto);

        verify(addressRepository).findByRegionAndCityAndStreetAndHouseNumber(dto.region(), dto.city(), dto.street(), dto.houseNumber());
    }
